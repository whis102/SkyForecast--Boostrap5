...
{
    fetch( `http://api.weatherapi.com/v1/current.json?key=&q=${ cityInput }` )
        ...
        .then( data =>
        {
            ...
            if ( code == 1000 )
            {
                ...
                code == 1003 || code == 1006 || code == 1009 || code == 1030 || code == 1069 || code == 1087 || code == 1135 || code == 1273 || code == 1276 || code == 1276 || code == 1279 || code == 1282) {
